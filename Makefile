...
GITHUB_PROJ := https://github.com//slavonic/${NPM_PACKAGE}
...
browserify:
	...
	( printf "/*! ${NPM_PACKAGE} ${NPM_VERSION} ${GITHUB_PROJ} @license MIT */" ; \
		./node_modules/.bin/browserify ./ -s markdownitChurchSlavonic \
		) > dist/${NPM_PACKAGE}.js
	# Minify
	./node_modules/.bin/uglifyjs dist/${NPM_PACKAGE}.js -b beautify=false,ascii-only=true -c -m \
